...
export class CarModel implements Deserializable<CarModel>{
  ...
  constructor(carId: number, carUserId: number, carName: string, win: string, spz: string, km: number, carInfo: string, startDateError: Date, endDateError: Date, featureRepairDate: Date, doneWork: string, exist: Boolean, buyedParts: string, repairs: RepairModel) {
    this.carId = carId;
